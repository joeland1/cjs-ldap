...
g++ -static -fPIC \
    ...
    -I/usr/include/node \
    -std=c++23 -mno-outline-atomics \
    -c -o ldap-result.o ldap-result.cpp || exit 1
...
g++ -static -fPIC \
    ...
    -I/usr/include/node \
    -std=c++23 -mno-outline-atomics \
    -c -o ldap-result-obj.o ldap-result-obj.cpp || exit 1
...
g++ -static -fPIC \
    ...
    -I/usr/include/node \
    -std=c++23 -mno-outline-atomics \
    -c -o generic-async.o generic-async.cpp || exit 1
...
g++ -static -fPIC \
    ...
    -I/usr/include/node \
    -std=c++23 -mno-outline-atomics \
    -c -o tls_validation_settings.o tls_validation_settings.cpp || exit 1
...
ld -fPIC -shared -static \
    -L/code/ldap-lib/lib \
    -o addon.node addon.o client.o ldap-result.o async-ldap-search.o async-bind-ldap.o async-ldap-close.o ldap-result-obj.o search_values.o generic-async.o tls_validation_settings.o -lldap -llber
